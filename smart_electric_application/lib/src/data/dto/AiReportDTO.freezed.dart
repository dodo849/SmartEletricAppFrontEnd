...
abstract class $AiReportDTOCopyWith<$Res> {
  factory $AiReportDTOCopyWith(
      ...
      _$AiReportDTOCopyWithImpl<$Res, AiReportDTO>;
  @useResult
  $Res call(
...
/// @nodoc
class _$AiReportDTOCopyWithImpl<$Res, $Val extends AiReportDTO>
...
/// @nodoc
class __$$_AiReportDTOCopyWithImpl<$Res>
    extends _$AiReportDTOCopyWithImpl<$Res, _$_AiReportDTO>
...
class _$_AiReportDTO implements _AiReportDTO {
  ...
  List<int> get timePeriodIndex {
    ...
    return EqualUnmodifiableListView(_timePeriodIndex);
  }

  final List<double> _timePeriodPowerUsage;
  @override
  List<double> get timePeriodPowerUsage {
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_timePeriodPowerUsage);
  }

  @override
  final double standbyPower;
  final List<int> _weekdayIndex;
  @override
  List<int> get weekdayIndex {
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_weekdayIndex);
  }

  final List<double> _weekdayPowerUsage;
  @override
  List<double> get weekdayPowerUsage {
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_weekdayPowerUsage);
  }
