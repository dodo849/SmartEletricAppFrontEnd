...
class BillSimulationProductCellViewModel extends GetxController {
  ...
  void onInit() {
    ...
    // print(BillSimulationViewModel.to.selectedProductsIndex);
    // print(BillSimulationViewModel.to.selectedProductsIndex.contains());
    // checkIsSelected();

    super.onInit();
  }

  void checkIsSelected(int index) {
    if (BillSimulationViewModel.to.selectedProductsIndex.contains(index)) {
      isSelected(true);
    }
  }
