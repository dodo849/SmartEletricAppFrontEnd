...
class AiReport extends GetView<AiReportViewModel> {
  ...
  Widget build(BuildContext context) {
    ...
    var bannerTitleTextStyle = TextStyle(
        color: CommonColors.onBlack, fontSize: 22, fontWeight: FontWeight.bold);
    var bannerBodyTextStyle = TextStyle(
        color: CommonColors.onBlack, fontSize: 13, fontWeight: FontWeight.w500);
                        ...
                        children: [
                          ...
                          Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Image.asset(
                                      'assets/images/avata_woman_paper.png',
                                      width: 125,
                                      fit: BoxFit.cover),
                                  SizedBox(
                                    width: 10,
                        ...
                        : Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 20),
                                // Content 5 Card
                                controller.aiReport.value.dayOrNight ==
                                        "daytime"
                                    ? DayTypeCard()
                                    : NightTypeCard(),
