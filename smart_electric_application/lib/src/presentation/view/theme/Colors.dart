...
class LightColors {
  ...
  static const Color gray4 = Color(0xFFADADAD);
...
class DarkColors {
  ...
  static const Color yellow1 = Color(0xFFFFD269);
  static const Color yellow2 = Color(0xFFFFD269);
  static const Color blue = Color(0xFF5196FF);
  static const Color purple = Color(0xFF7F7EEC);
  ...
  static const Color gray4 = Color(0xFF646464);
